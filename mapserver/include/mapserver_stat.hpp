...
class MapserverStat : private Mapserver<mrpt::maps::COccupancyGridMap2D, nav_msgs::OccupancyGrid, mrpt::maps::COccupancyGridMap2D::cellType, MapserverStat> {
 ...
 public:
  ...
  boost::shared_ptr<cv::Mat> doColorMapCallback(std::vector<mrpt::maps::COccupancyGridMap2D> mapStack);
  ...
  void calcIsm4Mapserver(const double xIsmCenter_m, const double yIsmCenter_m, const double phiIsm_rad, const double ismResolution, cv::Mat &ismInRoi, cv::Mat &ism);
